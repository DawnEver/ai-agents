...
**How to apply:** All path references updated across ~16 files (SKILL.md, 01-08 step files, 4 reviewer agents, polisher, AGENT.md, manuscript-rerun/SKILL.md, ingest.py). sed-based bulk replacement + manual edits for layout docs. Old ongoing/ papers need re-ingest or manual migration.
