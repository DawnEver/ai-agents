...
from literature_review.acquire import oa_resolve, researchgate
from literature_review.acquire.types import Blocked
from literature_review.acquire.verify import (  # re-exported for existing callers
    safe_filename,
    sha256_file,
    validate_pdf,
)
...
from literature_review.acquire.engine import (  # noqa: E402
    DEFAULT_LIMIT,
    HARD_LIMIT,
    acquire_pdfs,
)
