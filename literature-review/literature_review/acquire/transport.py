...
from literature_review.acquire import http_fetch, researchgate
from literature_review.acquire.types import Blocked, Denied, NotOpenAccess, Source
from literature_review.acquire.verify import is_pdf_bytes
...
class BrowserTransport:
        ...
        def on_response(response: Any) -> None:
            ...
            try:
                ...
                if "pdf" not in content_type and not response.url.lower().endswith(".pdf"):
                    return
                body = response.body()
            except Exception:  # noqa: BLE001 - body is not always retrievable
                return
    ...
    def _goto(self, url: str) -> None:
        ...
        except Exception:  # noqa: BLE001 - a download or abort is fine here
            pass
