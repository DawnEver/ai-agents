...
from literature_review.acquire.transport import Transport, default_transports
from literature_review.acquire.types import (
    Attempt,
    DownloadRecord,
    Outcome,
    Source,
...
def plan_sources(
    ...
    from literature_review.acquire.transport import needs_browser
