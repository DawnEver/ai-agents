...
F_TITLE = 1; F_ABSTRACT = 2; F_DATE = 6; F_URL = 13; F_ACCESS_DATE = 14
F_VOLUME = 19; F_PAGES = 32; F_PUBLICATION = 38; F_DOI = 59; F_ISSUE = 76
...
def _sqlite_available() -> bool:
    try:
        ...
        conn.execute("SELECT 1 FROM items LIMIT 1"); conn.close()
        return True
