...
读取 `articles/<slug>/repo-analysis.md` 获取项目数据。
...
2. **挖清水**：追问——还有什么角度？别人不会想到的切入点？用户真正的痛点？反常识洞察？
...
按照 `templates/审校checklist.md` 执行完整三遍审校。审校在 working context 中迭代，直接输出最终版到 `articles/<slug>/wechat.md`。
