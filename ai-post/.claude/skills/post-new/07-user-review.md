# Step 8: ⭐ User Draft Review — MANDATORY READ-THROUGH
...
**生成结果**：
- 小红书：articles/<slug>/xiaohongshu.md (<char_count> chars)
- 微信公众号：articles/<slug>/wechat.md (<char_count> chars)
- 知乎：articles/<slug>/zhihu.md (<char_count> chars)
- Twitter/X：articles/<slug>/twitter.md (<tweet_count> tweets)
...
- **If user approves** ("可以审了" / "进入会审" / "review it") → proceed to Step 9 (三方会审).
